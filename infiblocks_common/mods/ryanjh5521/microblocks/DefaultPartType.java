...
public class DefaultPartType implements PartType<Part> {
	...
	@SideOnly(Side.CLIENT) private void getBrightnessXFace(RenderBlocks rb, int bx, int by, int bz, double f_dx) {
	...
	@SideOnly(Side.CLIENT) private void getBrightnessYFace(RenderBlocks rb, int bx, int by, int bz, double f_dy) {
	...
	@SideOnly(Side.CLIENT) private void getBrightnessZFace(RenderBlocks rb, int bx, int by, int bz, double f_dz) {
	...
	@SideOnly(Side.CLIENT) private void renderAABB(Tessellator t, AxisAlignedBB aabb, RenderBlocks rb, int bx, int by, int bz, Block par1Block, boolean[] dontRenderFaces) {
