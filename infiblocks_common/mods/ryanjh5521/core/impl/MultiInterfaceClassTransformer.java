	...
	public byte[] transform(String untransformedName, String className, byte[] bytes) {
		...
		if(cn.visibleAnnotations != null)
			for(AnnotationNode n : (List<AnnotationNode>)cn.visibleAnnotations)
				if(n.desc.equals("Lmods/ryanjh5521/core/api/MultiInterfaceClass;"))
					miAnnotation = n;
		...
		if(miAnnotation != null) {
			...
			System.out.println("[ryanjh5521 Core] Creating multi-interface inheritance chain: "+Joiner.on(" extends ").join(inheritanceChain));
