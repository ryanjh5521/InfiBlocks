package mods.ryanjh5521.core.porting;


import java.io.File;

import mods.ryanjh5521.core.api.porting.PortableBlockRenderer;
...
public class ClientProxy142 extends CommonProxy142 {
	...
	public boolean isOp(String player) {
		return player.equalsIgnoreCase(Minecraft.getMinecraft().session.username);
	}
